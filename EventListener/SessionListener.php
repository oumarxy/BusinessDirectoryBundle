<?php
namespace SavoirFaireLinux\BusinessDirectoryBundle\EventListener;

use SavoirFaireLinux\BusinessDirectoryBundle\Controller\ApplicationController;
...
class SessionListener extends ApplicationListener {
